...
doctor:
    @echo "Running diagnostics for rsr-julia-library-template-repo..."
...
tour:
    @echo "=== rsr-julia-library-template-repo Tour ==="
    @echo ""
...
help-me:
    @echo "=== rsr-julia-library-template-repo Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/rsr-julia-library-template-repo/issues/new"
    @echo ""
